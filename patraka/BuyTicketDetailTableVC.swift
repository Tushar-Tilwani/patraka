...
class BuyTicketDetailTableVC: UITableViewController {
    ...
    func confirmAction(){
        ...
        let params = [Constants.userId:"1",Constants.userName:"John Wick",Constants.vendorName:vendor![Constants.vendorName].string!,"date":date,"quantity":quantity,"vendorId":vendor!["_id"].string!]
